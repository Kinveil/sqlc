...
## [1.27.0](https://github.com/Kinveil/sqlc/releases/tag/1.27.0)
...
## [1.26.0](https://github.com/Kinveil/sqlc/releases/tag/1.26.0)

Released 2024-03-28

### Release notes

This release is mainly a bug fix release. It also includes an [important security fix](https://github.com/Kinveil/sqlc/issues/3194) for users using output plugins.
...
## [1.25.0](https://github.com/Kinveil/sqlc/releases/tag/v1.25.0)
...
If you run into any issues with the updated dependencies, please [open an issue](https://github.com/Kinveil/sqlc/issues).
...
## [1.24.0](https://github.com/Kinveil/sqlc/releases/tag/v1.24.0)
...
By using gRPC interfaces, we can even (theoretically) support [remote plugins](https://github.com/Kinveil/sqlc/pull/2938), but that's something for another day.
...
## [1.23.0](https://github.com/Kinveil/sqlc/releases/tag/v1.23.0)
...
issues](https://github.com/Kinveil/sqlc/issues?q=is%3Aissue+label%3Aanalyzer)
...
The database-backed analyzer currently supports PostgreSQL, with [MySQL](https://github.com/Kinveil/sqlc/issues/2902) and [SQLite](https://github.com/Kinveil/sqlc/issues/2903)
...
## [1.22.0](https://github.com/Kinveil/sqlc/releases/tag/v1.22.0)
...
## [1.21.0](https://github.com/Kinveil/sqlc/releases/tag/v1.21.0)
...
## [1.20.0](https://github.com/Kinveil/sqlc/releases/tag/v1.20.0)
...
We've completed our migration to the [sqlc-dev/sqlc](https://github.com/Kinveil/sqlc) repository. All existing links and installation instructions will continue to work. If you're using the `go` tool to install `sqlc`, you'll need to use the new import path to get v1.20.0 (and all future versions).
...
go install github.com/Kinveil/sqlc/cmd/sqlc@v1.20.0
```

We designed the upgrade process to be as smooth as possible. If you run into any issues, please [file a bug report](https://github.com/Kinveil/sqlc/issues/new?assignees=&labels=bug%2Ctriage&projects=&template=BUG_REPORT.yml) via GitHub.
...
## [1.19.1](https://github.com/Kinveil/sqlc/releases/tag/v1.19.1)
...
## [1.19.0](https://github.com/Kinveil/sqlc/releases/tag/v1.19.0)
...
The [sqlc-gen-kotlin](https://github.com/Kinveil/sqlc-gen-kotlin) and
[sqlc-gen-python](https://github.com/Kinveil/sqlc-gen-python) plugins have been
...
## [1.18.0](https://github.com/Kinveil/sqlc/releases/tag/v1.18.0)
...
## [1.17.2](https://github.com/Kinveil/sqlc/releases/tag/v1.17.2)
...
## [1.17.1](https://github.com/Kinveil/sqlc/releases/tag/v1.17.1)
...
## [1.17.0](https://github.com/Kinveil/sqlc/releases/tag/v1.17.0)
...
## [1.16.0](https://github.com/Kinveil/sqlc/releases/tag/v1.16.0)
...
## [1.15.0](https://github.com/Kinveil/sqlc/releases/tag/v1.15.0)
...
## [1.14.0](https://github.com/Kinveil/sqlc/releases/tag/v1.14.0)
...
## [1.13.0](https://github.com/Kinveil/sqlc/releases/tag/v1.13.0)
...
## [1.12.0](https://github.com/Kinveil/sqlc/releases/tag/v1.12.0)
...
## [1.11.0](https://github.com/Kinveil/sqlc/releases/tag/v1.11.0)
...
## [1.10.0](https://github.com/Kinveil/sqlc/releases/tag/v1.10.0)
...
## [1.9.0](https://github.com/Kinveil/sqlc/releases/tag/v1.9.0)
...
## [1.8.0](https://github.com/Kinveil/sqlc/releases/tag/v1.8.0)
...
## [1.7.0](https://github.com/Kinveil/sqlc/releases/tag/v1.7.0)
...
## [1.6.0](https://github.com/Kinveil/sqlc/releases/tag/v1.6.0)
...
## [1.5.0](https://github.com/Kinveil/sqlc/releases/tag/v1.5.0)
...
## [1.4.0](https://github.com/Kinveil/sqlc/releases/tag/v1.4.0)
...
## [1.3.0](https://github.com/Kinveil/sqlc/releases/tag/v1.3.0)
...
## [1.2.0](https://github.com/Kinveil/sqlc/releases/tag/v1.2.0)
...
## [1.1.0](https://github.com/Kinveil/sqlc/releases/tag/v1.1.0)
...
## [1.0.0](https://github.com/Kinveil/sqlc/releases/tag/v1.0.0)
...
## [0.1.0](https://github.com/Kinveil/sqlc/releases/tag/v0.1.0)
